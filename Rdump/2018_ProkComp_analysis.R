...
ggbarplot(STRCheckM, x = "stringency", y = "nr_of_genomes",fill='black',color = "black",sort.val = "desc",sort.by.groups = FALSE,x.text.angle = 45)
print(STRCheckM)
...
tr1 = ggtree(RAxMLANVIORooted)
tr2 = ggtree(RAxMLCampbellRooted)
tr3 = ggtree(RAxMLRinkeRooted)
tr4 = ggtree(RAxMLRiboProtRooted)
