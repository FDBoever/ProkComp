...
selected='vibrioferrin'
selected='thiamine_tp'
selected='thiamine_tpmore'
selected='urea_MAQU'
selected='ureABCDEF_MAQU'
selected='ureABCDEF_HP15'
selected='terullium'

selected='succinate_dehydrogenase'
selected='sorbitol'


selected='pvdQ2_pseudo'
selected='pilin_HP15'
selected='phosphonate_20041'
selected='phn_operon_pseudo'
selected='phenol_HP15'
selected='petrobactin'
selected='nprs_pseudomonas'
selected='formate_pseudomonas'
selected='formate1_dehydro_NKSG1'
...
selected='TRAP_mannitol'
selected='chemotaxis_HP15'
selected='cobalaminDG'
selected='benzene_degradation'

selected='benzoate_degradation'
selected='benzene_degradation'


selected='lipidA_HP15'
selected='betacarotene_test'
