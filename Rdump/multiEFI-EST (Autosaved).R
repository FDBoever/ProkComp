...
alkB_cytoscape = read.csv('~/Downloads/18637_02831_full_ssn.xgmml')
...
for(i in c(1:nCycles)){
	...
	download.file(paste('http://www.ebi.ac.uk/Tools/dbfetch/dbfetch?db=uniprotkb&id=',URLencode(paste(selectedACCession[start:end],collapse='%2C')),'&format=fasta&style=raw&Retrieve=Retrieve',sep=''), paste('~/',i,'02831_uniprot_atpd.fasta',sep=''))
